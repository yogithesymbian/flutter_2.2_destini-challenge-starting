...
//TODO: Step 23 (DONE) - Use the storyNumber property inside getStory(), getChoice1() and getChoice2() so that it gets the updated story and choices rather than always just the first (0th) one.

//TODO: Step 8 (DONE) - Create a method called getStory() that returns the first storyTitle from _storyData.

//TODO: Step 11 (DONE) - Create a method called getChoice1() that returns the text for the first choice1 from _storyData.

//TODO: Step 12 (DONE) - Create a method called getChoice2() that returns the text for the first choice2 from _storyData.
...
//TODO: Step 16 (DONE) - Create a property called storyNumber which starts with a value of 0. This will be used to track which story the user is currently viewing.
...
//TODO: Step 21 (DONE-KAY) - Using the story plan, update nextStory() to change the storyNumber
//depending on the choice made by the user.
//e.g. if choiceNumber was equal to 1 and the storyNumber is 0, the storyNumber should become 2.

//TODO: Step 22 (DONE-KAY) - In nextStory() if the storyNumber is equal to 3 or 4 or 5,
//  that means it's the end of the game and it should call a method called restart() that resets the storyNumber to 0.

//TODO: Step 27 (DONE) - Create a method called buttonShouldBeVisible()
